    ...
    <Section className="pt-24 md:pt-32 pb-8">
      ...
      <Reveal delay={0.25} direction="up">
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          <Link to="/contact">
            <Button size="lg" className="sheen-hover silver-gradient text-primary-foreground font-bold text-base px-8 py-6">
              {hero.cta1}
            </Button>
          </Link>
          <Link to="/services">
            <Button size="lg" variant="outline" className="border-primary/40 hover:bg-primary/10 text-base px-8 py-6 group font-semibold">
      ...
      <Reveal delay={0.35}>
        <p className="mt-8 text-sm font-medium text-muted-foreground/60 tracking-wide uppercase">{hero.trust}</p>
      </Reveal>
    </Section>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Reveal delay={0.1}>
          <HoverCard className="h-full flex flex-col">
            ...
            <p className="text-base text-muted-foreground mb-5 font-medium">{growthTracks.business.audience}</p>
            ...
            <div className="mt-auto">
              <Link to="/services">
                <Button className="sheen-hover silver-gradient text-primary-foreground font-bold w-full group/btn text-base py-5">
        ...
        <Reveal delay={0.2}>
          <HoverCard className="h-full flex flex-col">
            ...
            <p className="text-base text-muted-foreground mb-5 font-medium">{growthTracks.executive.audience}</p>
            <ul className="space-y-3 mb-6">
