...
export const growthTracks = {
  ...
  business: {
    ...
    audience: "For trades, service businesses, SMEs, & startups.",
    services: [
    ...
    focus: [
      ...
      "Reduced admin & manual workload",
      "Operational visibility across the business",
      "Scalable, repeatable systems",
      "Structured sales & pipeline automation",
      "Clear positioning & offer design",
    ],
    cta: "More Details",
  },
  executive: {
    ...
    services: [
      { title: "AI Education", desc: "Practical workflows, tool selection frameworks, & prompt systems." },
      { title: "Personal Automation", desc: "Automate recurring tasks - communication, admin, & scheduling." },
      { title: "Execution Cadence", desc: "Weekly operating systems with defined KPIs & review mechanisms." },
      { title: "Decision Frameworks", desc: "Structured models for prioritisation, delegation, & allocation." },
      { title: "Communication & Positioning", desc: "Refine how you present ideas, pitch initiatives, & lead teams." },
      { title: "Time & Energy Architecture", desc: "Design your calendar, routines, & environment for performance." },
    ],
    outcomes: [
      { title: "Smarter Decisions", desc: "Better information leads to faster, more confident decision making." },
      { title: "Improved Execution Cadence", desc: "Weekly operating rhythms with clear KPIs, reviews, & accountability." },
      { title: "Reduced Cognitive Load", desc: "Automation handles the repetitive so you can focus on what matters." },
      { title: "Higher Output Per Hour", desc: "Structured systems & routines that compound your effectiveness." },
    ],
    focus: [
      "Improved decision-making",
      "Tech. education and AI literacy",
      "Consistent weekly execution",
      "Reduced cognitive load & context switching",
