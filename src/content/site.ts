...
export const growthTracks = {
  ...
  executive: {
    ...
    services: [
      { title: "AI Education", desc: "Practical workflows, tool selection frameworks, and prompt systems." },
      { title: "Personal Automation", desc: "Automate recurring tasks across communication, admin, and scheduling." },
      { title: "Execution Cadence", desc: "Weekly operating systems with defined KPIs and review mechanisms." },
      { title: "Decision Frameworks", desc: "Structured models for prioritisation, delegation, and allocation." },
      { title: "Communication & Positioning", desc: "Refine how you present ideas, pitch initiatives, and lead teams." },
      { title: "Time & Energy Architecture", desc: "Design your calendar, routines, and environment for performance." },
    ],
    outcomes: [
